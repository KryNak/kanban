    ...
    return (
        ...
        <div style={isMobileViewMode ? styles.mobileCollapse : styles.leftSectionCollapse}>
            <div style={isMobileViewMode ? styles.mobileMenu : styles.leftSection}>
                ...
                <div style={{ ...styles.themeMode, backgroundColor: isDarkMode ? 'rgba(33,33,45,255)' : 'rgba(245,247,254,255)', marginBottom: isMobileViewMode ? '5em' : '0', zIndex: isMobileViewMode ? '3' : 'inherit', position: 'relative' }}>
